...
class Heap5:
    ...
    def fifth_child(self, j):
        return 5*j + 5

    def has_fifth_child(self, j):
        return self.fifth_child(j) < len(self)
                ...
                if self.has_third_child(j):
                    ...
                    if self.has_fourth_child(j):
                        ...
                        if self._data[fourth] < self._data[small]:
                            small = fourth
                        if self.has_fifth_child(j):
                            fifth = self.fifth_child(j)
                            if self._data[fifth] < self._data[small]:
                                small = fifth
